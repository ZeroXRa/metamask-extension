...
export default {
  // The `title` affects the components tile and location in the storybook
...
| `primary`         | the principal call to action on the page                                                              |
| `secondary`       | secondary actions on each page                                                                        |
| `warning`         | a warning action on the page                                                                          |
